...
public class EbookController {
    ...
    @ApiOperation("默认查询全部专栏,传入分类id时查询分类下专栏")
    @GetMapping("/all")
    ...
    @ApiOperation("分页查询专栏,按照id降序排序")
    @ApiImplicitParam(name = "req", value = "传入分页参数,如果有传入专栏名则模糊查询专栏", required = true, dataType = "EbookQueryReq", paramType = "query")
    @GetMapping("/list")
